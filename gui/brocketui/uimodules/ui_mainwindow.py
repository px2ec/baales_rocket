...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbEnable.setGeometry(QtCore.QRect(20, 60, 94, 29))
        ...
        self.pbEnableTimer.setGeometry(QtCore.QRect(20, 140, 94, 29))
        self.pbEnableTimer.setObjectName(_fromUtf8("pbEnableTimer"))
        self.lblTimerSt = QtGui.QLabel(self.centralwidget)
        self.lblTimerSt.setGeometry(QtCore.QRect(130, 70, 101, 31))
        ...
        self.pbEnableParachute.setGeometry(QtCore.QRect(130, 140, 94, 29))
        ...
        self.pbReset.setGeometry(QtCore.QRect(20, 100, 94, 29))
        self.pbReset.setObjectName(_fromUtf8("pbReset"))
        self.pbDiffTrigger = QtGui.QPushButton(self.centralwidget)
        self.pbDiffTrigger.setGeometry(QtCore.QRect(130, 100, 94, 29))
        self.pbDiffTrigger.setObjectName(_fromUtf8("pbDiffTrigger"))
        self.frame.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbReset.setText(_translate("MainWindow", "Reiniciar", None))
        self.pbDiffTrigger.setText(_translate("MainWindow", "Diferencia Altura", None))
